...
public class DevicePage {
    public static final Target CONTAINER_COMPUTER=Target.the("CONTAINER FOR COMPUTER")
    ...
    public static final Target CONTAINER_VERSION=Target.the("Container for version")
    ...
    public static final Target CONTAINER_LANGUAGE=Target.the("Container for language")
    ...
    public static final Target CONTAINER_MOBILE_DEVICE=Target.the("Container for mobile device")
    ...
    public static final Target CONTAINER_MODEL_DEVICE=Target.the("Container for model device")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[2]/div[2]/div[2]/div"));
    public static final Target MODEL_DEVICE=Target.the("model device")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[2]/div[2]/div[2]/div/input[1]"));
    public static final Target CONTAINER_OS_MOBILE_DEVICE=Target.the("Container for so mobile device")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[2]/div[3]/div[2]/div"));
    public static final Target OS_MOBILE_DEVICE=Target.the("so mobile device")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/div[1]/div[3]/div[2]/div[3]/div[2]/div/input[1]"));
    public static final Target FINAL_BUTTON=Target.the("Button to final section")
            .located(By.cssSelector("a[aria-label='Next - final step'] span"));
